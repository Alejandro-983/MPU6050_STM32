...
#define MPU6050_RA_DMP_INT_STATUS   0x39 // DMP Interrupt Status

#define MPU6050_RA_BANK_SEL         0x6D // BANK_SEL register
#define MPU6050_RA_MEM_START_ADDR   0x6E // MEM_START_ADDR register
#define MPU6050_RA_MEM_R_W          0x6F // MEM_R_W register
#define MPU6050_RA_DMP_CFG_1        0x70 // DMP_CFG_1 Register
#define MPU6050_RA_DMP_CFG_2        0x71 // DMP_CFG_2 Register

// =========================== REGISTROS SELF-TEST MPU ======================================
...
#define MPU6050_RA_SMPLRT_DIV       0x19 // Sample Rate Divider register
#define MPU6050_RA_CONFIG           0x1A // Config Register
#define MPU6050_RA_GYRO_CONFIG      0x1B // Gyro Config Register
#define MPU6050_RA_ACCEL_CONFIG     0x1C // Accel Config Register
#define MPU6050_RA_FF_THR           0x1D // Free Fall Threshold
#define MPU6050_RA_FF_DUR           0x1E // Free Fall Duration
#define MPU6050_RA_MOT_THR          0x1F // Motion Detection Threshold
#define MPU6050_RA_MOT_DUR          0x20 // Motion Detection Duration
#define MPU6050_RA_ZRMOT_THR        0x21 // Zero Motion Threshold
#define MPU6050_RA_ZRMOT_DUR        0x22 // Zero Motion Duration
#define MPU6050_RA_FIFO_EN          0x23 // FIFO Enable

// ==================== REGISTROS DE LOS ESCLAVOS I2C DEL MPU6050 =====================
...
#define MPU6050_RA_INT_PIN_CFG      0x37 // INT pin Config
#define MPU6050_RA_INT_ENABLE       0x38 // INT Enable

#define MPU6050_RA_INT_STATUS       0x3A // Interrupt Status
...
#define MPU6050_RA_MOT_DETECT_STATUS    0x61 // Motion Detect Status
...
#define MPU6050_RA_FIFO_COUNTH      0x72 // Number of bytes stored in the FIFO buffer
#define MPU6050_RA_FIFO_COUNTL      0x73 // Number of bytes stored in the FIFO buffer
#define MPU6050_RA_FIFO_R_W         0x74 // FIFO Data Register
#define MPU6050_RA_WHO_AM_I         0x75 // I2C Address Register

// Posición del MSB bit y la longitud de los valores de TEST de Accel X,Y,Z
...
// Posición del MSB bit y la longitud de los valores de TEST de Gyro X,Y,Z
...
struct MPU6050_Handler {
	...
	float Angle_Pitch;
	float Angle_Roll;
	struct MPU6050_Quaternion Quaternion;
};
...
void CalibrateGyro(uint8_t Loops); // Fine tune after setting offsets with less Loops.
void CalibrateAccel_Default();
void CalibrateAccel(uint8_t Loops);// Fine tune after setting offsets with less Loops.
